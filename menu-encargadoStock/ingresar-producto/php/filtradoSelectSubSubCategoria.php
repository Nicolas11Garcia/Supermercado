...
$id_sub_categoria_seleccionada = $_POST['id_sub_categoria_seleccionada']; //OBTENEMOS EL ID DE LA CATEGORIA QUE SELECCIONO EN EL SELECT

$lista_sub_categoria_filtrada = $dao->buscarSubSubCategoriasSegunSubCategoria($id_sub_categoria_seleccionada); //BUSCAMOS TODAS LAS SUB-CATEGORIAS SEGUN LA CATEGORIA
...
<select>
    ...
    //IF PARA QUE NO LE LANCE "VER TODO" CUANDO NO HAY NINGUNA SUB-CATEGORIA SELECCIONADA Y NO OCURRA UN ERROR
