...
$id_categoria_seleccionada = $_POST['id_categoria_seleccionada']; //Variable para cuando aprete ver todo
...
//SI NO ES 0, OSEA QUE NO SELECCIONO VER TODO, PASA POR ACA Y BUSCAMOS SOLO LA CATEGORIA QUE SELECCIONO
    ...
    $lista_sub_categoria_filtrada = $dao->buscarSubSubCategoriasSegunSubCategoria($id_sub_categoria_seleccionada);
        echo '
    <table id="tabla">
    <thead>
        <tr>
