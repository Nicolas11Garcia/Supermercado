...
<body>
    ...
    <div class="contenedor-iframe-div">
        <div class="panel">
            <div class="opciones-principales" id="menus">
                ...
                if(isset($_SESSION['numero_caja'])){
                    ...
                    <div class="contenedor-perfil-caja">
                        <div class="numero-caja">
                            <p style="font-size:18px;">Caja: <span class="n-caja">'.$_SESSION['numero_caja'].'</span></p>
                        </div>
...
<script src="../assets/js/detectarAlerta.js"></script>
<script>
